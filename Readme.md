...
* Студент: [Алексей Е.](https://up.htmlacademy.ru/htmlcss/36/user/61758).
* Наставник: `Я`.
...
[Откройте мастер-репозиторий](https://github.com/htmlacademy-htmlcss/61758-sedona-36) и нажмите кнопку «Fork» в правом верхнем углу. Репозиторий из Академии скопируется в ваш аккаунт.
